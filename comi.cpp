...
void Comi::on_run_clicked()
{
    ...
    QMessageBox::information(this,"Result",dialog);
}

void Comi::Search_null(int num)
{
...
void Comi::paintEvent(QPaintEvent *)
{
    if (temp){
        ...
        for (int i=0;i<coun;i++)
        {
            ...
            paint.setPen(QPen(Qt::white, 2, Qt::SolidLine, Qt::FlatCap));
...
{
    ui->create->setStyleSheet("background-color: rgb(40, 40, 40); color: rgb(80, 150, 100);");
}
...
{
    ui->build->setStyleSheet("background-color: rgb(40, 40, 40); color: rgb(80, 150, 100);");
}

void Comi::on_run_pressed()
{
    ui->run->setStyleSheet("color: rgb(205, 205, 255);font-size: 24px;border: 2px solid rgb(205, 205, 255);");
}

void Comi::on_run_released()
{
    ui->run->setStyleSheet("background-color: rgb(40, 40, 40); color: rgb(80, 150, 100);");
}
